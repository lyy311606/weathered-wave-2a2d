...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/weathered-wave-2a2d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/weathered-wave-2a2d
```

A live public deployment of this template is available at [https://weathered-wave-2a2d.templates.workers.dev](https://weathered-wave-2a2d.templates.workers.dev)
